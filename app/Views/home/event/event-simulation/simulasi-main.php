                    ...
                    <div class="container__body simulasi__container">
                        <div class="box_item__container container_simulasi large-box">
                            ...
                            <div class="simulasi-footer-container text-center">
                                ...
                                <a href="<?= base_url("home/kerjakan_event_simulasi?id=" . $_GET['id'] . '&query=' . $_GET['query'] . '&utbk_session=' . $utbk_session + 1); ?>" style="display: none;" id="item_selesai_cekpoint" class="item_next"><span>Selesai</span></a>
                            </div>
                        </div>
...
<?= $this->include('home/event/event-simulation/simulasi-popup'); ?>

<script src="<?= base_url('assets/js/prevent-access.js') ?>"></script>
<script src="<?= base_url('assets/js/simulasi-event-control.js?v=') . time() ?>"></script>
