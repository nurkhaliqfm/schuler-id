                    ...
                    <div class="container__body simulasi__container">
                        <div class="box_item__container container_simulasi large-box">
                            ...
                            <div class="simulasi-footer-container text-center">
                                ...
                                <a href="<?= base_url("home/kerjakan_offline_simulasi?id=" . $_GET['id'] . '&m=' . $_GET['m'] . '&query=' . $_GET['query'] . '&utbk_session=' . $utbk_session + 1); ?>" style="display: none;" id="item_selesai_cekpoint" class="item_next"><span>Selesai</span></a>
                            </div>
                        </div>
...
<?= $this->include('home/event/event-simulation-offline/simulasi-popup'); ?>

<script src="<?= base_url('assets/js/prevent-access.js') ?>"></script>
<script src="<?= base_url('assets/js/simulasi-offline-control.js?v=') . time() ?>"></script>
...
<script>
    ...
    let urlRanking = "<?= base_url('home/save_offline_simulasi') ?>";
    let current_page = 1;
    let rows = 1;
    let timerUtbk = <?= $timer ?>;
