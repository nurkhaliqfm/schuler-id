                    ...
                    <form action="<?= base_url('admin/update_soal'); ?>" method="POST">
                        ...
                        <div class="grid-container option__style">
                            ...
                            <div class="input-group mb-3" id="optionEditor">
                                <input type="text" class="input__form <?= $answer_quest == "option_a" ?  "checked" : ""; ?> form-control <?= ($validation->hasError('option_a')) ? 'is-invalid' : ''; ?>" name="option_a" id="option_a" value="<?= old('option_a') ? old('option_a') : $bank_soal['option_a']; ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="grid-container option__style">
                            ...
                            <div class="input-group mb-3" id="optionEditor">
                                <input type="text" class="input__form <?= $answer_quest == "option_b" ?  "checked" : ""; ?> form-control <?= ($validation->hasError('option_b')) ? 'is-invalid' : ''; ?>" name="option_b" id="option_b" value="<?= old('option_b') ? old('option_b') : $bank_soal['option_b']; ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="grid-container option__style">
                            ...
                            <div class="input-group mb-3" id="optionEditor">
                                <input type="text" class="input__form <?= $answer_quest == "option_c" ?  "checked" : ""; ?> form-control <?= ($validation->hasError('option_c')) ? 'is-invalid' : ''; ?>" name="option_c" id="option_c" value="<?= old('option_c') ? old('option_c') : $bank_soal['option_c']; ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="grid-container option__style">
                            ...
                            <div class="input-group mb-3" id="optionEditor">
                                <input type="text" class="input__form <?= $answer_quest == "option_d" ?  "checked" : ""; ?> form-control <?= ($validation->hasError('option_d')) ? 'is-invalid' : ''; ?>" name="option_d" id="option_d" value="<?= old('option_d') ? old('option_d') : $bank_soal['option_d']; ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="grid-container option__style">
                            ...
                            <div class="input-group mb-3" id="optionEditor">
                                <input type="text" class="input__form <?= $answer_quest == "option_e" ?  "checked" : ""; ?> form-control <?= ($validation->hasError('option_e')) ? 'is-invalid' : ''; ?>" name="option_e" id="option_e" value="<?= old('option_e') ? old('option_e') : $bank_soal['option_e']; ?>">
                                <div class="invalid-feedback">
